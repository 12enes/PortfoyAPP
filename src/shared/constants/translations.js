export const TRANSLATIONS = {
  tr: {
    ...
    portfolioDist: 'Portföy Dağılımı', others: 'Diğer', cash: 'Nakit',
    performanceRankings: 'Performans Analizi', topPerformers: 'En Çok Kazandıranlar', worstPerformers: 'En Çok Kaybettirenler',
    BIST: 'BIST', TEFAS: 'Tefas Fonu', GOLD: 'Altın/Döviz', CRYPTO: 'Kripto', USA: 'ABD Hisse', INDEX: 'Endeks',
  ...
  en: {
    ...
    addToWatchInfo: 'You are about to add this asset to your watchlist.',
    ...
    portfolioDist: 'Portfolio Distribution', others: 'Others', cash: 'Cash',
    performanceRankings: 'Performance Analysis', topPerformers: 'Top Performers', worstPerformers: 'Worst Performers',
    BIST: 'BIST', TEFAS: 'Tefas Fund', GOLD: 'Gold/FX', CRYPTO: 'Crypto', USA: 'US Stock', INDEX: 'Index',
